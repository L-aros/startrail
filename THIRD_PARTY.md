...
| sodium / libsodium | 4.1.0+1 / 1.0.22 | BSD-3-Clause, ISC | Argon2id、XChaCha20-Poly1305、CSPRNG、安全密钥内存 | Proposed；等待 ADR-0005 |
| sqlite3 / SQLCipher / OpenSSL | 3.6.0 / build hook 锁定 / build hook 锁定 | MIT / BSD-style / Apache-2.0 | 加密派生索引 | Proposed；等待 ADR-0005 |
