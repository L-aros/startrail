/*
 * WARNING: do not edit!
 * Generated by configdata.pm from ../startrail-sqlite3-provenance/openssl-src/Configurations/common0.tmpl, ../startrail-sqlite3-provenance/openssl-src/Configurations/unix-Makefile.tmpl
 * via Makefile.in
 *
